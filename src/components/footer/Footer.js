        ...
        <div className="container py-5">
          <div className="row g-5">
            <div className="col-lg-3 col-md-6">
              ...
              <p className="mb-2"><i className="fa fa-map-marker-alt text-primary me-3" />29 MJD, Rajasthan, India</p>
              <p className="mb-2"><i className="fa fa-envelope text-primary me-3" />abcd@example.com</p>
              <p className="mb-0"><i className="fa fa-phone-alt text-primary me-3" />+919876543210</p>
            </div>
            <div className="col-lg-3 col-md-6">
        ...
        <div className="container">
          <div className="row g-5">
            ...
            <div className="col-md-6 text-center text-md-end">
              <p className="mb-0">Designed by <a className="text-primary" href>Harpinder</a></p>
            </div>
          </div>
        </div>
      </div>
